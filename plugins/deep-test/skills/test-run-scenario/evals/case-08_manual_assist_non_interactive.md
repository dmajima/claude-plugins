...
| 項目 | 内容 |
|-----|------|
| 委譲 args | `target-slug=order-management-web` / `run_id=R20260717-171000` / ケース: `[TC-UAT-005]`（`automation: manual-assist`。帳票の印字イメージ・画面レイアウトの妥当性など人手の目視確認が不可欠な受入ケース）/ アプリ情報: `https://localhost:5001` / `--non-interactive` |

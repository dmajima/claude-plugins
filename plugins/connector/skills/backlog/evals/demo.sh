...
check_file "case-07 (ユーザーキャンセル)" "$SCRIPT_DIR/case-07_user_cancel_post.md"
check_file "case-08 (HTTP 401)" "$SCRIPT_DIR/case-08_http_401_error.md"
check_file "case-09 (委譲パターン)" "$SCRIPT_DIR/case-09_delegation_read.md"

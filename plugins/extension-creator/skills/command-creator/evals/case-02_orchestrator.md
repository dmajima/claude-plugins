...
| 項目 | 値 |
|-----|---|
| 起動フレーズ | "`/extension` コマンドを作成。skill-creator / plugin-creator / agent-creator にルーティング" |
| 引数 | `extension --routes "skill:skill-creator,plugin:plugin-creator,agent:agent-creator"` |
| フラグ | なし |
| 既存状態 | 未存在 |

...
| S-1-7 | High | スキル直下 `references/scripts/setup/setup_venv.sh` 等の venv 関連スクリプトが存在しない（プラグイン直下に集約・ADR-024、Bash 標準・PowerShell フォールバック） | [scripts-policy.md](../../../references/scripts-policy.md) 節 5.2 |

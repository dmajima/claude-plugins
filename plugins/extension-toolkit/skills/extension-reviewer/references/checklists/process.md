...
`extension-reviewer` がレビュー結果を報告する直前に、**レビュー手順そのもの** が SSOT に従って実施されたかを自己点検するチェック項目。`common.md` の項目と併用すること。
...
| 項目 | 重大度 | 確認方法 | 出典 |
|-----|-------|---------|-----|
| PR-9-1 | Medium | Critical / High なし → `marketplace-publisher` への接続を提案している | [SKILL.md](../../SKILL.md) 節 7 |

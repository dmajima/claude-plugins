...
| `code-formatter/scripts/setup/setup_venv.sh` または `setup_venv.ps1` | 削除（プラグイン直下 `dev-toolkit/references/scripts/setup/setup_venv.ps1` に統合 / 既存があれば差分マージ。PowerShell 統一、shell-preference.md 準拠） |

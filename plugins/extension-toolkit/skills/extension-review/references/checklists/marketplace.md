...
| M-5-3 | Medium | `marketplace-toolkit` または `marketplace-publish` 経由で更新されている（手動編集よりツール経由を優先） | [architecture-decisions.md](../../../references/architecture/decisions-001-010.md) ADR-020 |

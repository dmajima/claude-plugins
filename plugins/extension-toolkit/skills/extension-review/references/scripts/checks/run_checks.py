#!/usr/bin/env python3
"""run_checks.py - extension-review 機械チェック一括実行スクリプト
...
# 自己参照（このスクリプト自身）と marketplace-publish のシークレットスキャン定義は
...
# --------------------------------------------------------------------------- #
# 9. シークレット混入チェック（marketplace-publish の secret-scan.md と同等）
# --------------------------------------------------------------------------- #
...
# 必要な PowerShell コードレビューは extension-review のメイン LLM レビューで

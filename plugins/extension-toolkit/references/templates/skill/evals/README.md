...
スキル新規作成・改修時の動作デモ用に [`demo.ps1`](demo.ps1) を同梱している。
...
新規スキル作成時はテンプレ（`references/templates/skill/evals/demo.ps1`）をコピーし、`{...}` プレースホルダを実際のコマンド・期待値で埋める。

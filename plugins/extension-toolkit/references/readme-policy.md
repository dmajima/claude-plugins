...
| 6 | プラグイン追加手順（メンテナ向け） | 推奨 | リポジトリ構成・新規プラグイン追加フロー |
| 7 | ライセンス・連絡先 | 該当時 | LICENSE / 連絡先 |
...
- 通常は `marketplace-publisher` がプラグインの公開フロー内で更新を行う（[`../skills/marketplace-publisher/references/publish-workflow.md`](../skills/marketplace-publisher/references/publish-workflow.md) のステップに含まれる）

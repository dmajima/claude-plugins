...
本ファイルは共通規約・禁止事項（旧 `conventions.md` 節 8〜14 に対応）。命名規約（節 1・6・7）は [`conventions-naming.md`](conventions-naming.md)、構造規約（節 2〜5）は [`conventions-structure.md`](conventions-structure.md) を参照。

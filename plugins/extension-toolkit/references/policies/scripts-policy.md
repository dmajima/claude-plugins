...
```bash
# 1. 構築（セッション開始時）
bash "$CLAUDE_PLUGIN_ROOT/references/scripts/setup/setup_venv.sh"   -WorkDir "$SessionDir/workspace"   -RequirementsPath "$CLAUDE_PLUGIN_ROOT/references/scripts/setup/requirements.txt"

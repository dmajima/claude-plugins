...
description: deep-code-review の観点別スキル。コード変更をフロントエンド観点（HTML/CSS/JS/テンプレート・アクセシビリティ・レスポンシブ）でレビュー。「フロントエンドをレビュー」「HTML/CSS/React/Vue/JS の変更を見て」「アクセシビリティを確認」や UI 変更時に起動する。Use when reviewing frontend or UI changes. SKIP when reviewing implementation/tests/security/architecture (use the matching code-review-* skill).
allowed-tools:
  - Read
  - Grep
  - Glob

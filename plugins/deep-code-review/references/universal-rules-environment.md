...
利用者環境のグローバルルール（スキル構成規約が存在する場合）と整合。プラグイン外利用者の場合は本規約のみで運用可能。
...
利用者環境のグローバルルール（ファイル文字コード規約が存在する場合）と整合。
...
利用者環境のグローバルルール（ローカルデータ領域規約が存在する場合）と整合。
...
利用者環境のグローバルルール（セッション作業領域規約が存在する場合）と整合。
...
利用者環境のグローバルルール（進捗管理規約が存在する場合）と整合。
...
利用者環境のグローバルルール（ポータブルパス規約が存在する場合）と整合。

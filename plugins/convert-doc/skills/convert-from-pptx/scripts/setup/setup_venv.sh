#!/usr/bin/env bash
# setup_venv.sh - convert-from-pptx スキル用 venv 構築スクリプト
#
# 使い方:
...
#             例: .claude/.local/work/20260512_01_convert_from_pptx/workspace

set -euo pipefail

WORK_DIR="${1:?エラー: WORK_DIR を第1引数に指定してください。例: setup_venv.sh .claude/.local/work/20260512_01_convert_from_pptx/workspace}"

#!/usr/bin/env bash
# teardown_venv.sh - convert-html スキル用 venv 削除スクリプト
#
# 使い方:
...
WORK_DIR="${1:?エラー: WORK_DIR を第1引数に指定してください。例: teardown_venv.sh .claude/.local/work/20260408_01_convert_html/workspace}"

# coding-php スキル evals

`coding-php` スキルの動作分岐ごとの期待挙動を定義するケース集。
...
| [case-05_wordpress-wpcs.md](case-05_wordpress-wpcs.md) | wp-config.php 検出 → WordPress Coding Standards へ切替 |

# coding-javascript スキル evals

`coding-javascript` スキルの動作分岐ごとの期待挙動を定義するケース集。
...
| [case-05_language-boundary.md](case-05_language-boundary.md) | tsconfig.json 検出 → coding-typescript へルーティング |

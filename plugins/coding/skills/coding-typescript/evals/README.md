# coding-typescript スキル evals

`coding-typescript` スキルの動作分岐ごとの期待挙動を定義するケース集。
...
| [case-05_language-boundary.md](case-05_language-boundary.md) | tsconfig.json 無し → coding-javascript へルーティング |

...
|----------|------|----------|----------|
| `extension-toolkit` | Claude Code の各種拡張要素（プラグイン・スキル・コマンド・エージェント・チーム・フック）の作成・改修からマーケットプレイス構築・公開までを支援するツールキット | 0.8.0 | `/plugin install extension-toolkit@dmajima-claude-plugins` |
